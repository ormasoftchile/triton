...
export const defaultTheme: ResolvedTheme = {
  ...
  spacing: baseSpacing,
  edges: { ...baseEdges, strokeWidth: 2, labelFontSize: 13 },
  panel: basePanel,
  nodes: {
    ...baseNodes,
    standard: { ...baseNodes.standard, cornerRadius: 4 },
    leaf: { ...baseNodes.leaf, cornerRadius: 8 },
  },
} as const;
...
export const editorialTheme: ResolvedTheme = {
  name: 'editorial',
  palette: {
    primary: '#EB6C36',
    secondary: '#2E5AA8',
  ...
  typography: {
    ...baseTypography,
    fontFamily: SANS,
    monoFamily: 'Geist Mono, JetBrains Mono, Fira Code, monospace',
    titleFontSize: 20,
  },
  spacing: baseSpacing,
  edges: baseEdges,
...
export const editorialDarkTheme: ResolvedTheme = {
  name: 'editorial-dark',
  palette: {
    primary: '#F08A59',
    secondary: '#6A95D8',
