...
function peg$parse(input, options) {
  ...
  var peg$f1 = function(id, text) { return { t: 'card', id: id || undefined, text: text.trim() }; };
  var peg$f2 = function(label) { return { t: 'col', label: label.trim() }; };
