...
function peg$parse(input, options) {
  ...
  var peg$e2 = peg$literalExpectation("section", true);
  ...
  var peg$f2 = function(label) { return { t: 'section', label: label.trim() }; };
  var peg$f3 = function(label, score, actors) {
      return { t: 'task', label: label.trim(), score, actors };
    };
  var peg$f4 = function(first, a) { return a; };
  var peg$f5 = function(first, rest) { return [first, ...rest].filter(Boolean); };
  var peg$f6 = function(a) { return a.trim(); };
  var peg$f7 = function(n) { return parseFloat(n); };
