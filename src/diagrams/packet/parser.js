...
function peg$parse(input, options) {
  ...
  var peg$f2 = function(start, e) { return e; };
  var peg$f3 = function(start, end, label) {
      return { t: 'field', start, end: end != null ? end : start, label };
    };
  var peg$f4 = function(s) { return s.trim(); };
  var peg$f5 = function(s) { return s.trim(); };
  var peg$f6 = function(n) { return parseInt(n, 10); };
