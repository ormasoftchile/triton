...
function peg$parse(input, options) {
  ...
  var peg$e0 = peg$literalExpectation("packet-beta", true);
  ...
  var peg$f8 = function(n) { return parseInt(n, 10); };
