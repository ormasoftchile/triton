...
import { bplustree } from '../diagrams/triton/ds/tree/bplustree.js';
...
import { merkletree } from '../diagrams/triton/ds/tree/merkletree.js';
import { lsmtree } from '../diagrams/triton/ds/tree/lsmtree.js';
import { behaviortree } from '../diagrams/triton/ds/tree/behaviortree.js';
import { quadtree } from '../diagrams/triton/ds/tree/quadtree.js';
import { treap } from '../diagrams/triton/ds/tree/treap.js';
import { tree234 } from '../diagrams/triton/ds/tree/tree234.js';
...
registerDiagram('bplustree', bplustree);
registerDiagram('b+tree', bplustree);
...
registerDiagram('merkletree', merkletree);
registerDiagram('lsmtree', lsmtree);
registerDiagram('behaviortree', behaviortree);
registerDiagram('quadtree', quadtree);
