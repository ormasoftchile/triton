...
function peg$parse(input, options) {
  ...
  var peg$e0 = peg$literalExpectation("mindmap", true);
  ...
  var peg$f2 = function(fmlines) {
      const meta = {}; for (const line of fmlines) { const m = line.match(/^\s*(\w+)\s*:\s*(.+?)\s*$/); if (m) meta[m[1]] = m[2]; } return meta;
    };
  var peg$f3 = function(indent, content) { return { indent: indent.length, raw: content.trim() }; };
  var peg$f4 = function(content) { return { indent: 0, raw: content.trim() }; };
