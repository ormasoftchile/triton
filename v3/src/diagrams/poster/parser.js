...
function peg$parse(input, options) {
  ...
  var peg$f6 = function(ids, span, kind, t) { return t; };
  var peg$f7 = function(ids, span, kind, theme, content) {
      addCell(ids.id, ids.title, kind, content, span || undefined, theme || undefined);
      return { type: 'cell' };
    };
  var peg$f8 = function(id, title) { return { id, title }; };
  var peg$f9 = function(id) { return { id, title: null }; };
  var peg$f10 = function(title) { return { id: null, title }; };
  var peg$f11 = function() { return { id: null, title: null }; };
  var peg$f12 = function(cols, rows) { return { colSpan: cols, rowSpan: rows }; };
  var peg$f13 = function(cols) { return { colSpan: cols, rowSpan: 1   }; };
  var peg$f14 = function(from, arrow, to, label, ann, block) {
      const result = {};
  ...
  var peg$f15 = function() { return 'straight'; };
  var peg$f16 = function() { return 'orthogonal'; };
  var peg$f17 = function() { return 'bezier'; };
  var peg$f18 = function() { return 'polyline'; };
  ...
  var peg$f21 = function(num) { return parseFloat(num); };
  ...
  var peg$f24 = function() { return { direction: 'bidirectional', style: 'solid' }; };
  var peg$f25 = function() { return { direction: 'bidirectional', style: 'dashed' }; };
  var peg$f26 = function() { return { direction: 'bidirectional', style: 'dotted' }; };
  var peg$f27 = function() { return { direction: 'directed', style: 'solid' }; };
  var peg$f28 = function() { return { direction: 'directed', style: 'dashed' }; };
  var peg$f29 = function() { return { direction: 'directed', style: 'dotted' }; };
  var peg$f30 = function() { return { direction: 'undirected', style: 'solid' }; };
  var peg$f31 = function() { return { direction: 'undirected', style: 'dashed' }; };
  var peg$f32 = function() { return { direction: 'undirected', style: 'dotted' }; };
  var peg$f33 = function(cell, node) { return { cellPath: [cell], nodeId: node }; };
  var peg$f34 = function(line) { return line; };
  var peg$f35 = function(lines) { return lines.join('\n'); };
  var peg$f36 = function(text) { return text; };
  var peg$f37 = function(digits) { return parseInt(digits, 10); };
