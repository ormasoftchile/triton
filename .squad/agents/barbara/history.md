...
- 2026-06-24: Removed the "cyclic diagrams hang renderSync" caveat from design/sections/09-latex-integration.tex (cycle-breaking bug fixed in PR #28). Updated intro "Three limitations"→"Two limitations"; the [width=] and --shell-escape caveats remain accurate. Full design PDF rebuilt clean via tectonic -Z shell-escape (exit 0, ~133KB).
