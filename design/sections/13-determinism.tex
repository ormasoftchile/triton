...
\begin{description}
  ...
  \item[Agent reliability.] AI agents can trust that their generated IR produces the expected visual. Round-trip editing (generate → render → inspect → regenerate) works.
