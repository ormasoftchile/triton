...
Fully implemented in \texttt{packages/core/src/grammars/timeline/} with all four layout families (horizontal, vertical-spine, serpentine, roadmap). Theme-driven rendering with support for ByteByteGo style, dark variants, and animated arc-spine nodes. No deferrals.
