...
This is a binding requirement established by David's research constraints (Constraint~7 in
\S\ref{sec:david-research}): without a machine-readable schema, agent generation is
