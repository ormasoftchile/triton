...
\ourdiagram{family-taxonomy}{%
  The five diagram families and their 22 member types, rendered as a mindmap
  using the \texttt{blueprint} theme.
  Each family shares a layout kernel; new types within a family require
  only a new parser and minor IR extensions.}
