...
alter geometry, and it may not require IR fields beyond those defined in the
grammar specifications~\cite{thinkcell,vegalite2017}.
...
\begin{itemize}
  \item \textbf{Data-independent.} A theme knows nothing about the content of the IR. It maps
        ...
        No IR field other than those defined in the grammar specifications is read.
