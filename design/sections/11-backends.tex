...
\ourdiagram[0.95\linewidth]{backend-arch}{%
  Backend architecture: Scene IR fans out to three backends.
  The SVG Backend is canonical---its SVG file is further rasterized by resvg (PNG)
  or converted to vector PDF.
  Skia renders art-effect PNG/PDF directly from Scene IR.
  PPTX Backend maps Scene IR primitives to native DrawingML shapes.}
