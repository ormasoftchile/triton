...
\ourdiagram[0.9\linewidth]{canvas-layout}{%
  Timeline canvas coordinate zones: the canvas splits into a Track Header Column
  (left, \texttt{Hhdr}~px wide) and a Content Area (right).
  The Content Area holds the Axis Header Row at the top,
  followed by Track~0 through Track~$N{-}1$, each \texttt{row\_height}~px tall.}
