...
Fully implemented in \texttt{packages/core/src/grammars/tree/} with the Buchheim--J{\"u}nger--Leipert O(n) tidy-tree layout algorithm. Supports recursive node nesting, custom node shapes, and full tree traversal. TreeTheme with light and dark variants.
