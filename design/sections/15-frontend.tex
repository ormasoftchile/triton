...
\begin{Verbatim}[frame=single,fontsize=\small]
  Path A: Mermaid-Superset DSL        Path B: Structured IR (JSON/YAML)
  (human-authored text)                (agent-emitted structured data)
        |                                      |
        v                                      v
  [Parser: PEG/Nearley]               [Schema Validation]
        |                                      |
        +----------------+---------------------+
                         |
                         v
...
\end{Verbatim}
\caption{Dual front-end: text DSL and structured IR converge at the Domain IR layer}
\label{fig:dual-frontend}
\end{figure}
