...
\ourdiagram[0.7\linewidth]{distribution-arch}{%
  Recommended distribution architecture: a single Core Library (render, validate,
  theme, schema) wrapped by five distribution targets --- CLI Binary, npm Package,
  MCP Server, VS Code Extension, and Docker Image.}
