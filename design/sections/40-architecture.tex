...
+------------------------------------------------------------------+
|                      COMPOSITION LAYER                           |
|   (arranges panels into posters; references grammar outputs)     |
+------------------------------------------------------------------+
        |               |               |               |
        v               v               v               v
+---------------+ +-------------+ +-------------+ +-----------+
|   Timeline    | |    Flow     | |    Graph    | | Comparison|
...
+------------------------------------------------------------------+
|                          KERNEL                                  |
|   Scene IR | Backends | Themes | Determinism | Icons | Lint     |
+------------------------------------------------------------------+
\end{Verbatim}
\caption{The three-layer architecture: Composition → Grammars → Kernel}
